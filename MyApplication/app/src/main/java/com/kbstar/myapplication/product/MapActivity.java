...
import com.kbstar.myapplication.databinding.ActivityMapBinding;
...
public class MapActivity extends AppCompatActivity
    ...
    String userName, siteName, siteAddress;
...
//                .setFastestInterval(FASTEST_UPDATE_INTERVAL_MS);
        ...
        binding.nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(binding.siteDistance.getText() == null) {
                    Toast.makeText(getApplicationContext(), "편의점을 선택하세요", Toast.LENGTH_LONG).show();
                } else {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                siteName = marker.getTitle();
                siteAddress = marker.getSnippet();

                binding.siteName.setText(siteName);
                binding.siteDistance.setText(siteAddress);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.menu_home) {
            ...
            Intent intent = new Intent(MapActivity.this, BagActivity.class);
            intent.putExtra("userName", userName);
            startActivity(intent);
        }
